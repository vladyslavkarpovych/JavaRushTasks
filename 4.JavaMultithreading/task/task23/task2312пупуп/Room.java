...
public class Room {
    ...
    public void sleep() throws InterruptedException {
        int sizeSnake = snake.getSections().size()-1;


//        int sizeSnake = 9;
//        for (int i = 11; i <=15 ; i++) {
//            long pause = 300-(300-200)*(i-10)/5;
//            System.out.println(i+"="+pause);
//        }
        if (sizeSnake==0){
            Thread.sleep(500);
        }
        if (sizeSnake>=1&&sizeSnake<=10){
            long pause = 500-(500-300)*(sizeSnake-1)/9;
            Thread.sleep(pause);
        }

        if (sizeSnake>10&&sizeSnake<=15){
            Thread.sleep(300-(300-200)*(sizeSnake-10)/5);
        }
